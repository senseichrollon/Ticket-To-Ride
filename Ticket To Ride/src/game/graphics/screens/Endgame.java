...
public class Endgame extends ScreenManager {
	...
	public Endgame(MouseInput input) {
		...
		exitButton = new MButton("Exit", new Font("TimesRoman", Font.BOLD | Font.ITALIC, 20), Color.GREEN,
				Color.orange);
		exitButton.setCenter(new Point(1650, 75));
		exitButton.setShape(MButton.ellipse(200, 75));

		screenButton = new MButton("View Game", new Font("TimesRoman", Font.BOLD | Font.ITALIC, 20), Color.GREEN,
				Color.orange);
